...
from multion.config.default import get_extended_config as get_task_config
...
_C.RL.SUBSUCCESS_REWARD_MEASURE = "pspl"
_C.RL.ORACLE_SUBSUCCESS_MEASURE = "oracle_sub_success"
_C.RL.NEW_REWARD_STRUCTURE = False
_C.RL.SUCCESS_REWARD = 3.0
_C.RL.SUBSUCCESS_REWARD = 3.0
_C.RL.SLACK_REWARD = -0.01
_C.RL.FALSE_FOUND_PENALTY = False
_C.RL.FALSE_FOUND_PENALTY_VALUE= 2.5
...
_C.RL.POLICY.pretrained_pointnav_depth_resolution = 256
# -----------------------------------------------------------------------------
